...
def build_relationships(entities):
    ...
    relationships.append(rel(
        ...
        timeframe="2024-07 to present",
        domain="domain-healthcare",
        project=["project-patient-letter-generation", "project-review-management-system"],
    ))
    relationships.append(rel(
    ...
    # === ADOBE / TekSystems relationships ===
    adobe_skills = [
    ...
    for sk in adobe_skills:
        relationships.append(rel(
            ...
            co_skills=[s for s in adobe_skills if s != sk],
        ))
    ...
    for sk in cg_skills:
        relationships.append(rel(
            ...
            timeframe="2020-01 to 2024-07",
            co_skills=[s for s in cg_skills if s != sk],
        ))
    ...
    # === DEPT OF VA / DocMe360 relationships ===
    va_skills = [
    ...
    for sk in metify_skills:
        relationships.append(rel(
            ...
            co_skills=[s for s in metify_skills if s != sk],
        ))
    ...
    for sk in cgi_skills:
        relationships.append(rel(
            ...
            co_skills=[s for s in cgi_skills if s != sk],
        ))
    ...
    for sk in mic_skills:
        relationships.append(rel(
            ...
            co_skills=[s for s in mic_skills if s != sk],
        ))
    ...
    # === BRUTE TECHNOLOGIES / Gardyn relationships ===
    relationships.append(rel(
        "skill-apache-kafka", "applied_in_project", "project-iot-control-systems",
        organization="org-gardyn",
        role="role-technology-development-consultant",
        domain="domain-ag-tech",
        timeframe="2002-03 to present",
        co_skills=["skill-python", "skill-aws"],
    ))
    relationships.append(rel(
    ...
    # === BRUTE TECHNOLOGIES / Telemedicine relationships ===
    relationships.append(rel(
        "skill-dicom", "applied_in_project", "project-telemedicine-imaging",
        organization="org-brute-technologies",
        role="role-technology-development-consultant",
        domain="domain-telemedicine",
        timeframe="2002-03 to present",
        co_skills=["skill-python", "skill-aws-s3", "skill-hl7-fhir"],
    ))
    relationships.append(rel(
    ...
    # === BRUTE TECHNOLOGIES / Ad-Tech relationships ===
    relationships.append(rel(
        "skill-aws-athena", "applied_in_project", "project-ad-analytics-pipelines",
        organization="org-brute-technologies",
        role="role-technology-development-consultant",
    ...
    # === Cross-cutting pattern relationships ===
    relationships.append(rel(
