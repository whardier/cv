...
TERM_TO_ENTITY_MAP = {
    ...
    "SQL": "skill-sql",  # Fundamental — used with PostgreSQL, Snowflake, Oracle, Athena
    "Bash": "skill-shell",
    "Shell": "skill-shell",
    "C": "skill-c",
    "C++": "skill-cpp",
    ...
    "SAML": "skill-saml",
    "OAuth": "skill-oauth",
    "OAuth 2.0": "skill-oauth",
    "SCIM": "skill-scim",
    "SSO": "skill-sso",
    "MFA": "skill-mfa",
    "REST API": "skill-rest-apis",
    "REST APIs": "skill-rest-apis",
    "webhooks": "skill-webhooks",
    "SNMP": "skill-snmp",
    "SIP": "skill-sip-iax",
    "IAX": "skill-sip-iax",
    "SMTP": "skill-smtp",
